...
LFD_API void EdgeDetect(unsigned char *dest, unsigned char *src, int width, int height)
{
	POINT	ImageSize;
	ImageSize.x = width;
	ImageSize.y = height;
...
LFD_API void EdgeDetectSil(unsigned char *edge, unsigned char *src, int width, int height)
{
